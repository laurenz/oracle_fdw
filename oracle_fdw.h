...
/* oracle_fdw version */
#define ORACLE_FDW_VERSION "2.7.0devel"
...
extern int oracleGetImportColumn(oracleSession *session, char *dblink, char *schema, char *limit_to, char **tabname, char **colname, oraType *type, int *charlen, int *typeprec, int *typescale, int *nullable, int *key, int import_tables, int import_views, int import_matviews);
