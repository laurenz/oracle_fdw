...
-- Test SORT-PUSHDOWN
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY id;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY c;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY nc;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY vc;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY nvc;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY lc;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY r;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY u;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY lb;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY lr;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY b;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY num;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY fl;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY db;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY d;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY ts;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY ids;
EXPLAIN (VERBOSE on, COSTS off) SELECT * FROM typetest1 ORDER BY iym;
